...
export const CadastroScreen: React.FC<CadastroProps> = ({ onSalvar, onVoltar }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput style={[styles.input, styles.textArea]} placeholder="Ex: Mato alto obstruindo canaleta." value={descricao} onChangeText={setDescricao} multiline numberOfLines={4} />
